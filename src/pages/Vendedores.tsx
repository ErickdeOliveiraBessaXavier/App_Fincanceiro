    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Funcionários e suas carteiras de vendas</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <Card>
          ...
          <CardContent><div className="text-2xl font-bold">{vendedores.length}</div></CardContent>
        </Card>
        <Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Cada vendedor administra a sua carteira de vendas</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <p className="py-8 text-center text-muted-foreground">
              Nenhum vendedor ainda. Crie um, ou eles são criados automaticamente na importação de CSV.
            </p>
          ) : (
